...
public ContactData(int id, String lastname, String firstname, String middlename, String address, String homePhone, String mobilePhone, String email, String group) {
  this.id = id;
  this.firstname = firstname;
  this.middlename = middlename;
  this.lastname = lastname;
